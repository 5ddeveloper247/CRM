    ...
    <tbody>
        <tr style="min-height: 22.5pt;">
            <td style="width: 418.5pt; background: #003ede;" colspan="4" valign="top" width="743"><strong><span
                        ...
                        GALAXY CRM NOTIFICATION</span></strong>
                <p>&nbsp;</p>
            </td>
        </tr>
        <tr style="min-height: 22.5pt;">
            <td style="border: solid #DFE0E2 1.0pt; padding: 0in 0in 0in 0in; min-height: 22.5pt;" colspan="4">
                <p class="yiv7050401279MsoNormal" style="margin-bottom: 12.0pt;"><span style="font-size: 10.0pt;">
                        <strong>Subject: </strong>New Task Assigned</span>
                </p>
                
                <p class="yiv7050401279MsoNormal" style="margin-bottom: 12.0pt;"><span style="font-size: 10.0pt;">
                        <strong>Greetings {{@$name}},</strong></span>
                </p>
                ...
                <p class="yiv7050401279MsoNormal" style="margin-bottom: 12.0pt;"><span style="font-size: 10.0pt;">
                        <strong>Task Details: </strong></span>
                </p>
            </td>
        </tr>
        ...
        <tbody>
            <tr style="min-height: 22.5pt;">
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp; <strong>Task Title</strong></span></p>
                </td>
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp; &nbsp;{{@$task_title}}</span>
                    </p>
                </td>
            </tr>
            <tr style="min-height: 22.5pt;">
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp; <strong>Building</strong></span></p>
                </td>
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp; &nbsp;{{@$building}}</span>
                    </p>
                </td>
            </tr>
            ...
            <tr style="min-height: 22.5pt;">
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp; <strong>Appartment</strong></span></p>
                </td>
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp; &nbsp;{{@$appartment}}</span>
                    </p>
                </td>
            </tr>
            <tr style="min-height: 22.5pt;">
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp; <strong>Description</strong></span></p>
                </td>
                <td style="border: solid #DFE0E2 1.0pt; padding: .75pt .75pt .75pt .75pt; min-height: 22.5pt;">
                    <p class="yiv7050401279MsoNormal"><span style="font-size: 9.0pt;">&nbsp; &nbsp;{{@$description}}</span>
                    </p>
                </td>
            </tr>
            ...
            <tr>
                <td style="width: 445.5pt; background: #F2F2F2; padding: 0in 5.4pt 0in 5.4pt;" colspan="8" valign="top"
                    width="743">
                    <p align="center">Copyright (c) {{date('Y')}}, GALAXY CRM. All rights reserved.</p>
                </td>
            </tr>
